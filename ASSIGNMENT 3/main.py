...
# ==========================================
# Day 4 Assignment Implementations
# ==========================================
...
def delete_product(product_id: int, response: Response):
    product = find_product(product_id)    # step 1: find it
    if not product:                         # step 2: if None → 404
        response.status_code = status.HTTP_404_NOT_FOUND
        return {'error': 'Product not found'}
    products.remove(product)               # step 3: remove from list
